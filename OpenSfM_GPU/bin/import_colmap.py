...
def cam_from_colmap_params(camera_model_id, width, height, params, prior_focal=1):
    ...
    """
    mapping = {1: 'pinhole', 2: 'perspective_simple', 3: 'perspective', 9: 'fisheye'}
    ...
    # Some experimental stuff, made from above, need to check what that "0" third parameter means hehehe.
    elif projection_type == 'perspective_simple':
        cam = pygeometry.Camera.create_perspective(focal, params[3], 0)
